...
export const blockDefs = [
  ...
  // 进阶坐标
  {
    ...
    args0: [
      ...
      { type: 'field_number', name: 'XMIN', value: -5, min: -20, max: 0, precision: 0.5 },
      { type: 'field_number', name: 'XMAX', value: 5, min: 0, max: 20, precision: 0.5 },
      { type: 'field_number', name: 'YMIN', value: -3, min: -20, max: 0, precision: 0.5 },
      { type: 'field_number', name: 'YMAX', value: 3, min: 0, max: 20, precision: 0.5 },
      { type: 'field_number', name: 'X', value: 0, min: -10, max: 10, precision: 0.1 },
      { type: 'field_number', name: 'Y', value: 0, min: -10, max: 10, precision: 0.1 },
    ],
    previousStatement: null, nextStatement: null,
  ...
  },
  {
    ...
    args0: [
      ...
      { type: 'field_number', name: 'T0', value: 0, min: -100, max: 100, precision: 0.01 },
      { type: 'field_number', name: 'T1', value: 3.14, min: -100, max: 100, precision: 0.01 },
  ...
  },
  {
    ...
    args0: [
      ...
      { type: 'field_number', name: 'XMIN', value: -5, min: -20, max: 0, precision: 0.5 },
      { type: 'field_number', name: 'XMAX', value: 5, min: 0, max: 20, precision: 0.5 },
      { type: 'field_number', name: 'YMIN', value: -4, min: -20, max: 0, precision: 0.5 },
      { type: 'field_number', name: 'YMAX', value: 4, min: 0, max: 20, precision: 0.5 },
      { type: 'field_number', name: 'ZMIN', value: -3, min: -20, max: 0, precision: 0.5 },
      { type: 'field_number', name: 'ZMAX', value: 3, min: 0, max: 20, precision: 0.5 },
    ],
    previousStatement: null, nextStatement: null,
