...
export const blockDefs = [
...

  {
    type: 'object_circle',
    message0: '创建圆形 %1',
    args0: [{ type: 'field_variable', name: 'VAR', variable: 'circle' }],
    previousStatement: null, nextStatement: null,
    colour: 230, tooltip: '创建一个圆形',
  },
  {
    type: 'object_square',
    message0: '创建正方形 %1',
    args0: [{ type: 'field_variable', name: 'VAR', variable: 'square' }],
    previousStatement: null, nextStatement: null,
    colour: 230, tooltip: '创建一个正方形',
  },
  {
    ...
    previousStatement: null, nextStatement: null,
    colour: 230, tooltip: '创建指定宽高的矩形',
  },
  {
    type: 'object_triangle',
    message0: '创建三角形 %1',
    args0: [{ type: 'field_variable', name: 'VAR', variable: 'triangle' }],
    previousStatement: null, nextStatement: null,
    colour: 230, tooltip: '创建一个等边三角形',
  },
  {
    ...
    previousStatement: null, nextStatement: null,
    colour: 230, tooltip: '创建正 N 边形',
  },
  {
    type: 'object_dot',
    message0: '创建点 %1',
    args0: [{ type: 'field_variable', name: 'VAR', variable: 'dot' }],
    previousStatement: null, nextStatement: null,
    colour: 230, tooltip: '创建一个点',
  },
  {
    type: 'object_line',
  ...
  },
  {
    ...
    previousStatement: null, nextStatement: null,
    colour: 260, tooltip: '用 LaTeX 公式创建公式对象',
  },
  {
    ...
    previousStatement: null, nextStatement: null,
    colour: 260, tooltip: '用 LaTeX 创建数学公式（默认斜体）',
  },
  {
    type: 'object_text',
